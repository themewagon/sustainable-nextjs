  ...
  return (
    <>
      <section
        ...
        style={
          {
            "--work-line-bg": `url(${getImgPath(
              "/images/work-grow/work-line.png"
            )})`,
          ...
          <div className="container py-20">
            <div className="flex flex-wrap">
              ...
              >
                ...
                <button
                  className="bg-white text-base font-normal text-primary py-3 px-12 rounded-lg mb-16 mt-8 transition-all duration-0.4s hover:bg-secondary hover:text-white"
              ...
              <div
                ...
                style={
                  {
                    "--grid-line-bg": `url(${getImgPath(
                      "/images/hero/grid-line.png"
                    )})`,
                    "--circal-bg": `url(${getImgPath(
                      "/images/hero/circal.png"
                    )})`,
                  } as React.CSSProperties
                }
                data-aos="fade-left"
